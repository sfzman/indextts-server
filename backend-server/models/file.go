...
type File struct {
	...
	UserID      string         `gorm:"type:varchar(36);index;not null;uniqueIndex:idx_files_user_oss_key" json:"user_id"`
	Filename    string         `gorm:"type:varchar(255);not null" json:"filename"`
	OSSKey      string         `gorm:"type:varchar(512);not null;uniqueIndex:idx_files_user_oss_key" json:"oss_key"`
